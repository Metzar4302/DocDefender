        ...
        public bool ValidateChain(){
            for (int i = 1; i < this.Chain.Count; i++){
                ...
                if (current.hash != current.GenerateHash()){
                    PrintWithColor($"[{current.hash.Substring(0, Tools.difficult + 5)}...] The current hash of the block does not equal the generated hash of the block", ConsoleColor.Red);
                    return false;
                }
